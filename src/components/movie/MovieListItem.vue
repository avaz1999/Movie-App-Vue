<template >
        ...
        :class="[{like: movie.like}, {favourite: movie.favourite}]">
                <span 
                @click="$emit('onTogle',{id: movie.id, prop: 'like'})"
                class="list-group-item-label">{{ movie.name }}
        </span>
                ...
                <div class="d-flex justfy-content center align-items-center">
                        ...
                        @click="$emit('onTogle',{id: movie.id, prop: 'favourite'})">
...
.list-group-item.favourite .list-group-item-lebel,
